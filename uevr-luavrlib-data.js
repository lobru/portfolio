...
window.PROGRESS_DATA = {
  meta: {
    ...
    featuresAdded: [
      ...
      { name: "Array reading fixed",
        desc: "Reading arrays of numbers, strings, or objects from the game engine now returns correct values for every type. Previously, non-pointer arrays returned garbage." },
      ...
      { name: "Live function caller",
        desc: "A pinned panel in the object inspector lets you drop any in-game object onto a slot and call functions on it directly, without navigating the class tree each time." },
  ...
  milestones: [
    ...
    { date: "2026-05-25", label: "Multi-viewport re-enabled w/ candidate fixes", kind: "in-progress", cardId: "mv-pump" },
