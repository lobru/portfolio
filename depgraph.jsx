// depgraph.jsx — Dependency graph for ImGuiColorTextEdit progress dashboard.
// Layered DAG: Fold Engine → Navigation → Integration → Bug Fixes → Open/Next
...
function DepGraph({ data }) {
  ...
  const layers = [
    {
      x: 40, title: "Fold Engine",
      nodes: ["python-fold", "docstring-fold", "fold-preview", "fold-arrow", "fold-click", "fold-all"],
    },
    {
      x: 310, title: "Navigation",
      nodes: ["chord-shortcuts", "drag-text", "header-toggle", "goto-include", "reopen-tab"],
    },
    {
      x: 580, title: "Integration",
      nodes: ["runtime-langs", "dll-packaging", "file-dialog-favs", "script-runner"],
    },
    {
      x: 850, title: "Bug Fixes · shipped",
      nodes: ["y-scroll-fix", "scroll-to-fold", "deindent-fix", "tab-roundtrip", "fold-on-edit", "sdl3-drop"],
    },
    {
      x: 1160, title: "Open / Next",
      nodes: ["cursor-x-bug", "fold-row-bug", "word-context-feat", "jump-def-feat"],
    },
  ];
